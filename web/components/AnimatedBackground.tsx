export function AnimatedBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 z-[-1] overflow-hidden bg-ground">
      ...
      */}
      <div className="absolute -left-[20%] -top-[20%] h-[70%] w-[70%] animate-wave-1 rounded-full bg-[var(--player-blue-fill)] opacity-25 mix-blend-multiply blur-[100px] dark:opacity-20" />
      <div className="absolute -right-[20%] -bottom-[20%] h-[70%] w-[70%] animate-wave-2 rounded-full bg-[var(--player-yellow-fill)] opacity-25 mix-blend-multiply blur-[100px] dark:opacity-20" />
      <div className="absolute left-[20%] top-[30%] h-[60%] w-[60%] animate-wave-3 rounded-full bg-[var(--player-pink-fill)] opacity-20 mix-blend-multiply blur-[120px] dark:opacity-15" />
